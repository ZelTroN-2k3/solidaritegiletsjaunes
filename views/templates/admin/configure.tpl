...
<div class="panel">
	...
	<p>
		...
		{l s='I can configure it using the following configuration form.' mod='solidaritegiletsjaunes'}
	</p>
	<br />
	<p>
		{l s='This module will boost your sales!' mod='solidaritegiletsjaunes'}
	</p>
</div>

<div class="panel">
	<h3><i class="icon icon-tags"></i> {l s='Documentation' mod='solidaritegiletsjaunes'}</h3>
	<p>
